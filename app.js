...
let newObjectLit = () => ({key1: 'value1', key2: 'value2', key3: 'value3'});
...
// When this is invoked, it references the object Joe that was constructed using the Student constructor. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//When this is invoked, it references an object, but instead of using the Student constructor, the object is called Window. 
// 3. Explain why "this" is different when an arrow function is used.
//This happens with arrow functions because they do not have their own bindings to this, arguments, or super, and should not be used as methods. They also cannot be used as constructors. 